        ...
        <div className=" ring-4 ring-green-300 rounded-xl shadow-xl">
            ...
            <div className="flex flex-col p-7">
                <div className="flex flex-row justify-center items-center">
                    <div className="text-2xl uppercase bg-green-300 p-1 px-3 text-white rounded-2xl">
                        {name}
                    </div>
                </div>
                <div>
                ...
                <div className='bg-white mt-4 rounded-full text-3xl text-green-500 w-2/4 mx-auto'>
